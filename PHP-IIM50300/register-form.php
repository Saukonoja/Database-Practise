   ...
   <div id="errorMessageContainer">
     <div id=errorMessage>{$error}</div>
         ...
         <div id="formContainerLoginRegister">
              ...
              <button class='buttons' id='btnBackToLogin' onclick="window.location.href='login-form.php'">Back to Login</button><br>
              <button class='buttons' id='btnBackToMain' onclick="window.location.href='index.php'">Back to Music database</button>      
          </div>	  
    </body>
 </html>
